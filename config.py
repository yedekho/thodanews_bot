...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://dotequity:Achiadi@123@cluster0.hst9mig.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "dotequity")
